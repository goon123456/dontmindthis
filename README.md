...
The Player tab includes rebindable noclip, vehicle fly, a subtle ESP toggle with scaling name/distance text and a tiny side health bar, plus optional chams. Vehicle fly uses WASD with Space/E to rise and LeftCtrl/Q to descend while seated in a vehicle.
